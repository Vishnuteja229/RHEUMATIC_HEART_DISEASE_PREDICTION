...
main = tkinter.Tk()
main.title("Rheumatic Heart Disease Detection using Deep Learning from Heart Sounds")
...
font = ('times', 14, 'bold')
title = Label(main, text='Rheumatic Heart Disease Detection using Deep Learning from Heart Sounds')
...
predictButton = Button(main, text="Predict RHD from Test Sound", command=predict)
